import { canvasW, canvasH, deltaTime, ctx1, endGame } from './main';
import scoreImg from '../imgs/score_bg.png';
import timerImg from '../imgs/timer_bg.png';

export var dataObj = function () {
...
dataObj.prototype.init = function () {
    ...
    this.time = 30;
    this.alpha = 0;
    this.scorePic.src = scoreImg;
    this.timePic.src = timerImg;
};
